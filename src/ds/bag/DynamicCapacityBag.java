 ...
 * ANSWERS PDF: Are we testing the dy
 * namic nature of the new bag implementation? Justify in a short paragraph.
 * 
 * Task 2:
...
public class DynamicCapacityBag<Item> implements Bag<Item> {
	...
	//default dynamic capacity bag with the size of 10
